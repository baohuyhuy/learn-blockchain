...
class BalanceGraph:
    ...
    def plot_balance_graph(self):
        ...
        plt.savefig(f"balance_graph_{self.wallet_address[:8]}...{self.wallet_address[-4:]}.png", dpi=300)
        print(f"Balance graph saved as balance_graph_{self.wallet_address[:8]}...{self.wallet_address[-4:]}.png")
